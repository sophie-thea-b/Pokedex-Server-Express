...
## Example Front-End
I have [developed a Pokedex Android application that consumes this API.](https://github.com/sophie-thea-b/Pokedex-App-Android) It can be used as an example to develop other front-ends that consume this API.
